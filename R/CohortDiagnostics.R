...
#'                                   to have write privileges in this schema. Note that for SQL Server,
#'                                   this should include both the database and schema name, for example
#'                                   'cdm_data.dbo'.
#' @param vocabularyDatabaseSchema   Schema name where your OMOP vocabulary data resides. This is
#'                                   commonly the same as cdmDatabaseSchema. Note that for SQL Server,
#'                                   this should include both the database and schema name, for example
#'                                   'vocabulary.dbo'.
#' @param cohortTable                The name of the table that will be created in the work database
#'                                   schema. This table will hold the exposure and outcome cohorts used
#'                                   in this study.
#' @param tempEmulationSchema        Some database platforms like Oracle and Impala do not truly
#'                                   support temp tables. To emulate temp tables, provide a schema with
#'                                   write privileges where temp tables can be created.
...
#' @param incrementalFolder          Name of local folder to hold the logs for incremental run; make
#'                                   sure to use forward slashes (/). Do not use a folder on a network
